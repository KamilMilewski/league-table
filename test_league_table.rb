...
class TestLeagueTable < Minitest::Test
  ...
  def test_that_can_get_losses
    assert_equal 0, @lt.get_losses('Man Utd')
    assert_equal 2, @lt.get_losses('Liverpool')
    assert_equal 0, @lt.get_losses('Jagiellonia Białystok')
    assert_equal 0, @lt.get_losses('Barcelona')
    assert_equal 1, @lt.get_losses('Real Madryt')
    assert_equal 1, @lt.get_losses('Legia')
    assert_equal 1, @lt.get_losses('Mońki')
    assert_equal 0, @lt.get_losses('Sokółka')
  end
end
