...
class TestLeagueTable < Minitest::Test
  ...
  def test_parse_match_method
    ...
    assert_equal 'Man Utd',   parsed_match[:team_left_name]
    assert_equal 3,           parsed_match[:team_left_goals]
    assert_equal 'Liverpool', parsed_match[:team_right_name]
    assert_equal 0,           parsed_match[:team_right_goals]
  end
